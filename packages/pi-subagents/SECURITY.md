...
This document explains the security model behind `@herbertgao/pi-subagents` and
...
[GitHub Security Advisories](https://github.com/HerbertGao/pi-extensions/security/advisories/new)
for this repository.
