...
const pi = (await import("@earendil-works/pi-coding-agent")) as Record<
  string,
  unknown
>
...
describe.skipIf(!MIGRATED)(
  "PR #152 reach: real ModelRegistry exposes .runtime (Pi >= 0.80.8)",
  () => {
