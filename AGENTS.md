...
- Preserve upstream attribution and original license notices. Record source repository, package, version, and commit in `x-upstream` metadata for imports; mark packages authored here with `x-origin: original`.
